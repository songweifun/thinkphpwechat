                    ...
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>

                                            <td><?php echo ($item["title"]); ?></td>
                                            <td><?php echo ($item["name"]); ?></td>
                                            <td>
                                                <?php if(in_array($item['name'],$areadyInstall)): ?><a href="<?php echo U('unInstall',array('name'=>$item['name']));?>" class="btn btn-default btn-sm">卸载</a>
                                                <?php else: ?>
                                                    <a href="<?php echo U('install',array('name'=>$item['name']));?>" class="btn btn-primary btn-sm">安装</a><?php endif; ?>
                                            </td>
