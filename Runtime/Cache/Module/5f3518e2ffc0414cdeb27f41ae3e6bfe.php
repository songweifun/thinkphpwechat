                    ...
                    <section class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                <?php if(is_array($buttons)): $i = 0; $__LIST__ = $buttons;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>

                                            <td><?php echo ($item["id"]); ?></td>
                                            <td><?php echo ($item["title"]); ?></td>

                                            <td>
                                                <?php if($item['status'] == 1): ?><a href="<?php echo site_url('button.push',['id'=>$item['id']]);?>" class="btn btn-danger btn-sm" disabled="disabled">已推送</a>
                                                    <?php else: ?>
                                                    <a href="<?php echo site_url('button.push',['id'=>$item['id']]);?>" class="btn btn-primary btn-sm">待推送</a><?php endif; ?>
                                                &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;
                                                    <a href="<?php echo site_url('button.set',['id'=>$item['id']]);?>" class="btn btn-default btn-sm">编辑</a>
                            ...
                            <div>
                                <a href="<?php echo site_url('button.set');?>" class="btn-sm btn-primary" >添加菜单</a>
                            </div>
