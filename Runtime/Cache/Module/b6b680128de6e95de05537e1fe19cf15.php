        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <table class="table table-hover table-bordered table-container">
                    ...
                    <tbody>
                    <?php if(is_array($modules)): $i = 0; $__LIST__ = $modules;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($v["rid"]); ?></td>
                            <td><?php echo ($v["keyword"]); ?></td>
                            <td>
                                <a href="<?php echo U('Module/Keyword/set',['mo'=>$_GET['mo'],'rid'=>$v['rid']]);?>" class="btn btn-primary  btn-sm active" role="button">编辑</a>
                                <a href="<?php echo U('Module/Keyword/set',['mo'=>MODULE]);?>" class="btn btn-default  btn-sm active" role="button">删除</a>
                            </td>
                ...
                <div>
                    <a href="<?php echo U('Module/Keyword/set',['mo'=>MODULE]);?>" class="btn-sm btn-primary">添加关键词</a>
                </div>
