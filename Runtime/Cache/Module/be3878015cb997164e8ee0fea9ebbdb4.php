            ...
            <div class="panel-body">
                <form role="form" action="" method="post">
                    <div class="form-group">
                        <label>关注时回复</label>
                        <input type="text" class="form-control" name="welcome" value="<?php echo ($system["welcome"]); ?>">
                    </div>
                    <div class="form-group">
                        <label>默认回复</label>
                        <input type="text" class="form-control" name="default" value="<?php echo ($system["default"]); ?>">
                    </div>
